...
ampArray=np.linspace(-0.5, 0.5, 100)
if __name__ == '__main__':
    ...
    W, Q, hvi = pwh.definePulseAndUpload(amp.piPulseTuneUpReal, module_dict, pulse_general_dict, subbuffer_used=1)
    ...
    fa.pi_pulse_tune_up(I, Q, ampArray)