...
def define_instruction_compile_hvi(module_dict: dict, Q, pulse_general_dict: dict, subbuffer_used=0):
    ...
    syncWhileCondition = kthvi.Condition.register_comparison(subBufferReg2, kthvi.ComparisonOperator.LESS_THAN_OR_EQUAL_TO, SYNC_WHILE_LOOP_ITERATIONS)
        ...
        for module in module_dict_temp.keys():
            ...
            for timeIndex, actionList in time_sort_order.items():
                ...
                if actionList == []:
                    ...
                    # if timeIndex == list(time_sort_order.keys())[-1] and module==primaryEngine:
